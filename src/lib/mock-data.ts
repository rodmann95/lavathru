...
export const CLIENTS: Client[] = [
  ...
  },
  {
    ...
    name: "Empresa Frotas LTDA",
    plate: "MER0T55",
    plates: ["MER0T55", "BRA2E19", "RJH2M45"],
    phone: "(31) 97777-2233",
    visits: 128,
...
export const USERS: User[] = [
  {
    id: "u-001",
    name: "Gabrielle Rodmann",
    email: "gabrielle.rodmann@grupoeuphoria.com.br",
    role: "franquia",
  },
  {
    id: "u-002",
    name: "Carlos Souza",
    email: "carlos.souza@lavathru.com.br",
    role: "franqueado",
    franchiseId: "f-001",
    franchiseIds: ["f-001", "f-002"],
  },
  {
    id: "u-003",
    name: "Amanda Lima",
    email: "amanda.lima@lavathru.com.br",
    role: "operador",
    franchiseId: "f-003",
    franchiseIds: ["f-003"],
  },
...
function generateSales(): Sale[] {
  ...
  for (let d = 0; d < 90; d++) {
    ...
    for (let i = 0; i < dayCount; i++) {
      ...
      const hasProducts = Math.random() > 0.2;
      const saleProducts: string[] = [];
      if (hasProducts) {
        const count = 1 + Math.floor(Math.random() * 2);
        for (let pIdx = 0; pIdx < count; pIdx++) {
          const prod = PRODUCTS[Math.floor(Math.random() * PRODUCTS.length)];
          saleProducts.push(prod.name);
        }
      }

      const plate = plates[Math.floor(Math.random() * plates.length)];
      const isUnregistered = ["BHZ5W77", "SPA9L23"].includes(plate);
      ...
      sales.push({
        ...
        products: saleProducts.length > 0 ? saleProducts : undefined,
        amount: payment === "Assinatura" ? 0 : service.price,
        payment,
        franchiseId: franchise.id,
        type: payment === "Assinatura" ? "assinatura" : "avulsa",
        clientName: isUnregistered ? undefined : names[Math.floor(Math.random() * names.length)],
      });
    }
  }
  return sales;
...
export const PLANS: Plan[] = [
  {
    ...
    price: 199,
    lavagesIncluded: 8,
    description: "Até 8 lavagens por mês",
    royaltyPercent: 10,
    costCenterId: "cc-002",
  ...
  },
  {
    ...
    price: 269,
    lavagesIncluded: 12,
    description: "Até 12 lavagens por mês",
    royaltyPercent: 10,
    costCenterId: "cc-002",
    targetAudience: "Ambos",
    showOnWebsite: true,
  },
  {
    ...
    price: 799,
    lavagesIncluded: 40,
    description: "Uso comercial / Frotas - Até 40 lavagens por mês",
    royaltyPercent: 12,
    costCenterId: "cc-002",
    targetAudience: "PJ",
    showOnWebsite: true,
...
export const MOCK_FINANCIAL_ENTRIES: FinancialEntry[] = [
  ...
  {
    id: "fe-001",
    description: "Desenvolvimento do App / Infra AWS",
    amount: 4800,
    dueDate: "2026-07-25",
    status: "pending",
    type: "pagar",
  ...
  {
    id: "fe-002",
    description: "Agência de Marketing Nacional",
    amount: 2500,
    dueDate: "2026-07-20",
    status: "paid",
    type: "pagar",
  ...
  {
    id: "fe-003",
    description: "Taxa de Implantação Unidade Batel",
    amount: 25000,
    dueDate: "2026-07-15",
    status: "paid",
    type: "receber",
  ...
  {
    id: "fe-004",
    description: "Venda de Equipamentos (Aspiradores)",
    amount: 8500,
    dueDate: "2026-07-30",
    status: "pending",
    type: "receber",
  ...
  {
    id: "fe-005",
    description: "Aluguel Comercial Pátio",
    amount: 3500,
    dueDate: "2026-07-10",
    status: "paid",
    type: "pagar",
  ...
  {
    id: "fe-006",
    description: "Folha de Pagamento - Operadores",
    amount: 6200,
    dueDate: "2026-07-05",
    status: "paid",
    type: "pagar",
  ...
  {
    id: "fe-008",
    description: "Parceria Estacionamento Conveniado",
    amount: 1500,
    dueDate: "2026-07-20",
    status: "pending",
    type: "receber",
  ...
  {
    id: "fe-009",
    description: "Aluguel Comercial Savassi",
    amount: 2800,
    dueDate: "2026-07-10",
    status: "paid",
    type: "pagar",
  ...
  {
    id: "fe-010",
    description: "Energia e Luz Comercial",
    amount: 650,
    dueDate: "2026-07-15",
    status: "pending",
    type: "pagar",
